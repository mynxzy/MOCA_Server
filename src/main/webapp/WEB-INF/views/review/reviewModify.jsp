...
<body>
	<div id="wrap">
        ...
        <form action="/review/reviewModify" method="post">
            ...
            <input type="hidden" name="rno" value="${rmodify.rno}">
            <div>
                <p>제목</p>
                <input type="text" name="title" class="title" value="${rmodify.title}">
            </div>
            <div>
                <p>내용</p>
                <textarea rows="20" name="content" class="content">${rmodify.content}</textarea>
            </div>
